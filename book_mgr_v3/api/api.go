...
func main(){
	...
	http.HandleFunc("/book/searchAuthor",LogHandle(searchBookAuthor))
	http.HandleFunc("/student/add",LogHandle(addStudent))
	http.HandleFunc("/student/borrow",LogHandle(borrow))
	http.HandleFunc("/student/bookList",LogHandle(bookList))
	http.HandleFunc("/book/",LogHandle(getTop10))
